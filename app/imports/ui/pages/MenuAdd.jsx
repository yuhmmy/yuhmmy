...
class MenuAdd extends React.Component {
  ...
  submit(data, formRef) {
    const {
      menuItemName, menuItemPrice, menuItemImage, menuItemIngredients, menuItemRestaurantId, menuItemAllergyId,
      menuItemEthnicityId, menuItemIsDrink,
    } = data;
            ...
            <Grid.Column>
              <AutoForm ref={ref => {
                ...
                <Segment stacked padding="very" className="segment" inverted>
                  <Header as='h2' textAlign='center' className='headerColor' color='teal'> Add A
                    Menu Item </Header>
                  <TextField
                      label='Menu Name:'
                      name='restaurantName'
