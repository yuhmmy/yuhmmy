...
class OrderCard extends React.Component {
  ...
  deleteOrder(suborderId) {
    SubOrders.update(suborderId, {
      $set: { subOrderIsFinished: true },
    });
  }
    ...
    return (
        <div>
          <div className="order-card-item">
            ...
            <br/>
            <Button
              onClick={() => this.deleteOrder(this.props.subOrder._id, this.props.subOrder.orderId)}
              size="massive"
              color="teal"
              fluid
            >
